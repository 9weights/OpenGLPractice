...
unsigned int textureSetup(const char* path)
{
...
int main()
{
    ...
    //# Texture stuff (containter)
    unsigned int textureID{textureSetup("/home/vimto/chalf/OpenGLPractice/texture_source/container.jpg")};
